...
## Projects
- [Watchdog](https://github.com/bar-benjamin/Watchdog) - multithreaded monitoring program that runs in the background which monitors<br /> another program to see if it froze or crashed and restart it if needed
